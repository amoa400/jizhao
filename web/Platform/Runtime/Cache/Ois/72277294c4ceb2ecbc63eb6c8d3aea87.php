...
<div class="header">
	<span class="title">面试管理</span>
</div>

<div class="mytoolbar mytoolbar_table" style="margin-top:15px;">
	<!--<span class="item mybtn mybtn_primary new_tab" style="margin:0;" md_tab_name="新增面试" md_url="/ois/ois_interview/create">创建</span>-->
	<span class="item item_t mybtn mybtn_primary" style="margin:0;" md_id_name="talent_id" md_confirm="1" md_op_url_tmp="<?php echo U('ois/ois_interview/deleteList');?>" md_title="确认删除？" md_content="您即将删除您选中的求职者，请确认操作！" md_button_text="删除">删除</span>
...
<div class="mytable" style="margin-top:15px;">
	<table>
		...
		<tr>
			<td><input type="checkbox" value="<?php echo ($interview["interview_id"]); ?>"></td>
			<td><?php echo ($interview["interview_id"]); ?></td>
			<td><a class="new_tab" md_url='/ois/ois_interview/show/interview_id/<?php echo ($interview["interview_id"]); ?>'><?php echo ($interview["name"]); ?></a></td>
			...
			<td>
				<a class="new_tab" md_url="ois/ois_interview/edit/interview_id/<?php echo ($interview["interview_id"]); ?>"><span class="mylabel mylabel_info">编辑</span></a>&nbsp;
				<a href="javascript:void(0)" class="open_confirm_window" md_title="确认删除？" md_content="您即将删除<span class='danger'><?php echo ($interview["interview_id"]); ?>号面试-<?php echo ($interview["name"]); ?></span>，请确认操作！" md_button_text="删除" md_button_class="mybtn_danger" md_op_url="<?php echo U('ois/ois_interview/delete?interview_id='.$interview['interview_id']);?>"><span class="mylabel mylabel_danger">删除</span></a>&nbsp;
				<a href="javascript:void(0)" class="popbox_t" md_box_id="<?php echo ($interview["interview_id"]); ?>" md_left="-93" md_top="-6px" md_width="80" md_border_width="3" md_background="#ffffff" md_border_color="#468847" md_btn_height="29"><span class="mylabel mylabel_success">更多</span></a>
				<div class="popbox popbox_<?php echo ($interview["interview_id"]); ?>">
