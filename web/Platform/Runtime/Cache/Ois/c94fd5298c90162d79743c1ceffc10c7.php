...
<div class="header">
	<span class="title">编辑面试 - <?php echo ($interview["name"]); ?></span>
</div>
...
<div class="myform" style="margin-top:15px;">
	<form name="form" action="<?php echo U('/rms/rms_talent/editDo');?>" method="post"  enctype="multipart/form-data">
		<div class="item">
			...
			<input type="text" value="<?php echo ($intreview["intreview_id"]); ?>" disabled="disabled">
			<input name="talent_id" type="text" value="<?php echo ($intreview["intreview_id"]); ?>" class="hidden">
			<span class="tip"></span>
		</div>
		<div class="item">
