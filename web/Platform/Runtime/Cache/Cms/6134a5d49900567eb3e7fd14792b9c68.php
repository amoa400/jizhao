...
<div name="cms" class="control_menu">

	<div name="company" class="item">
		<span class="lv1">
			<i class="icon1 icon1_blue icon1_overview"></i>&nbsp;&nbsp;&nbsp;公司管理
		</span>
		<div class="sub">
			<span name="overview" class="lv2">
				<i class="icon1 icon1_blank"></i>&nbsp;&nbsp;&nbsp;公司概览
			</span>
			<span name="infoEdit" class="lv2">
				<i class="icon1 icon1_blank"></i>&nbsp;&nbsp;&nbsp;信息修改
			</span>
		</div>
	</div>
	
	<div name="user" class="item">
		<span class="lv1">
			<i class="icon1 icon1_blue icon1_user1"></i>&nbsp;&nbsp;&nbsp;成员管理
		</span>
		<div class="sub">
			<span class="lv2">
				<i class="icon1 icon1_blank"></i>&nbsp;&nbsp;&nbsp;成员列表
			</span>
			<span class="lv2">
				<i class="icon1 icon1_blank"></i>&nbsp;&nbsp;&nbsp;新增成员
			</span>
		</div>
	</div>
...
<script>
	$(document).ready(function() {
		...
		else $('.item[name="company"] .lv2[name="overview"]').click();
	});
</script>
